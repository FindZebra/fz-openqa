...
answer = {"answer.target":0, "answer.text": ["Post polio syndrome"]}
...
rich.print("MetaMapMatch positive label:",em.classify(answer=answer, document=doc))
rich.print("SciSpacy positive label:",em.classify(answer=answer, document=doc))