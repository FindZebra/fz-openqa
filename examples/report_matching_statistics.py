...
from fz_openqa.datamodules.corpus_dm import MedQaCorpusDataModule, FzCorpusDataModule, FZxMedQaCorpusDataModule
...
parser = argparse.ArgumentParser(description="Generate reporting statistics on relevance classifiers")
parser.add_argument(
    "classifier",
    type=str,
    nargs="?",
...
corpus = corpus_module(tokenizer=tokenizer,
