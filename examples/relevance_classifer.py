...
b0 = {
    ...
    "answer.cui": [],
    "document.text": """Post polio syndrome is a condition that affects polio survivors years after recovery from the initial
...
b1 = {
    ...
    "answer.text": "Gallbladder cancer",
    "answer.cui": ["C0235782"],
    "document.text": """Carcinoma of the gallbladder (GBC) is the most common and aggressive form of biliary tract
...
b2 = {
    ...
    "answer.target": 0,
    "answer.text": "Psoriatic arthritis",
    "answer.cui": ["C0003872"],
    "document.text": """the fingers, nails, and skin. Sausage-like swelling in the fingers or toes, known as dactylitis,
...
b3 = {
    "question.text": """A 29-year-old man is admitted to the emergency department following a motorcycle accident.
        ...
        incapacitated patient?""",  # noqa: E501
    "answer.text": "The spouse",
    "answer.cui": [],
    "document.text": """ate) orders.durable power of attorney for health care (dpoahc): legally designates a surrogate health
        ...
        the patient.withdrawal of carepatients and their decision makers have the right to forgo or w""",  # noqa: E501
}
...
b4 = {
    ...
    cause of thispatient’s findings?""",  # noqa: E501
    "answer.text": "Abnormal calcium sensing receptors",
    "answer.cui": [],
    "document.text": """(1.1 to  1.3 mmol/l). both concentrations are tightly regulated. the total serum calcium level must
...
b5 = {
    ...
    is most likely responsible for the observed changes in milk production?""",  # noqa: E501
    "answer.text": "Progesterone",
    "answer.cui": [],
    "document.text": """by 24 mo)defined as < 2500 g. caused by prematurity or intrauterine growth restriction (iugr). associated
        ...
        infant infections and is associated with \xc2\x90 risk for chil""",  # noqa: E501
}
...
b6 = {
    "question.text": """A 38-year-old man arrives at the emergency department with severe periumbilical, colicky pain and abdominal
        ...
        palpation. Bowel sounds are high-pitched and tinkling.Which of the following is the most likely cause?""",  # noqa: E501
    "answer.text": "Small bowel obstruction",
    "answer.cui": [],
    "document.text": """ope in someone with a small bowel obstruction.problems playing this file? see media help.depending on
        ...
        bowel obstruction, the pain is felt lower in the abdo""",  # noqa: E501
}
...
b7 = {
    "question.text": """A 27-year-old man comes to the physician with throbbing right scrotal pain for 1 day. He has also had a
        ...
        pathogen of this patient's symptoms?""",  # noqa: E501
    "answer.text": "Chlamydia trachomatis",
    "answer.cui": [],
    "document.text": """r urethrapreventionnot having sex, condoms, sex with only one non\xe2\x80\x93infected persontreatment
        ...
        disease, which may result in future infertility or ectopic pregnancy. rep""",  # noqa: E501
}
...
b8 = {
    "question.text": """A 45-year-old man with a history of recurrent gouty arthritis comes to the physician for a follow-up
        ...
        benefit from treatment with which of the following drugs to prevent future gout attacks?""",  # noqa: E501
    "answer.text": "Probenecid",
    "answer.cui": [],
    "document.text": """two attacks), serum uric acid levels (progression is more rapid in patients with serum uric acid >535
        ...
        of less than 6 mg/dl. probenecid is generally not effe""",  # noqa: E501
}
...
b9 = {
    "question.text": """A 33-year-old woman is brought to the physician by her husband because of persistent sadness for the
        ...
        likely diagnosis?""",  # noqa: E501
    "answer.text": "Cyclothymic disorder",
    "answer.cui": [],
    "document.text": """aracterized by periods of de- pressive symptoms and periods of hypomanic symptoms, the lifetime presence
        ...
        including behaviors that reflect being separated from, and""",  # noqa: E501
}
...
b10 = {
    "question.text": """The incidence of a relatively benign autosomal recessive disease, X, is 1 in 25 in the population.
        ...
        male and female, who are carriers, will have a child expressing the disease?""",  # noqa: E501
    "answer.text": "1/4",
    "answer.cui": [],
    "document.text": """4, p. 289). if a couple has a child with an autosomal recessive disease, the recurrence risk is 25
        ...
        unless there is consanguinity or the part""",  # noqa: E501,
}
...
b11 = {
    "question.text": """A 68-year-old man comes to the physician because of a 4-month history of difficulty swallowing. During
        ...
        adenocarcinoma. The patient is scheduled for surgical resection of the tumor. During the procedure, the surgeon
         ...
         thoracic vertebra (T10). Which of the following structures was mostlikely damaged?""",  # noqa: E501
    "answer.text": "Vagus nerve",
    "answer.cui": [],
    "document.text": """x and abdomen pass through the diaphragm or between the diaphragm and its peripheral attachments:the
...
b12 = {
    "question.text": """A 42-year-old man presents to the emergency department with a 3-day history of fever and severe back pain.
        ...
        patient\xe2\x80\x99s condition?""",  # noqa: E501
    "answer.text": "Intravenous drug use",
    "answer.cui": ["C0699778"],
    "document.text": """118.vertebral osteomyelitis is often caused by staphylococci, but other bacteria or tuberculosis
        ...
        emergency settings and better tolerated by some patients with severe back pain. the intervertebral d""",  # noqa: E501
}
...
b13 = {
    "question.text": """A 62-year-old man presents with epigastric pain over the last 6 months. He says the pain gets worse with
        ...
        \xe2\x80\x99s condition?""",  # noqa: E501
    "answer.text": "Give amoxicillin, clarithromycin, and omeprazole",
    "answer.cui": ["C0002645", "C4077730", "C0028978", "C0055856", "C1947971"],
    "document.text": """curs in the antrum and may be caused by nsaid use or h. pylori infection. often asymptomatic, but associated
        ...
        omeprazole) to treat h. pylori infection.give prophylactic h2 b""",  # noqa: E501
}
...
b14 = {
    "question.text": """A 77-year-old man presents to his primary care physician with lightheadedness and a feeling that he is
        ...
        presyncope?""",  # noqa: E501
    "answer.text": "Right bundle branch block",
    "answer.cui": ["C0344421", "C0085615"],
    "document.text": """to identify the cause; and to assess risk for future episodes and serious harm (table 27-1). the initial
...
for i, eg in enumerate(exs):
    ...
    rich.print(f"[red]Answer: {eg['answer.text']}")
    rich.print(f"[white]Document: {eg['document.text']}")
    for c, b in output.items():
        _match_on = b["document.match_on"][i] if "document.match_on" in b else None
        rich.print(
            f"> {type(c).__name__}: match_score={b['document.match_score'][i]}, "
