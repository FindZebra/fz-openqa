...
b2 = {
    'question.text': "Which of the following factors gives the elastin molecule the ability to stretch and recoil?",
    # noqa: E501
    "answer.target": 0, "answer.text": ["Cross-links between lysine residues"],
...
class TestRelevanceClassifier(TestCase):
    ...
    def _wrap_classifier(self, classifier: RelevanceClassifier):
        ...
        """
        return ExpandAndClassify(classifier, axis=1, n_documents=self.n_docs)
