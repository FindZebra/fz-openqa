...
_TRAIN_URL = "https://drive.google.com/file/d/11Qg73P952cS4-zdQjSXu9Zcc4i13ooQq/view?usp=sharing"
_VALID_URL = "https://drive.google.com/file/d/16ONbC8UHYeykNDc_PKyhLQee28ap6657/view?usp=sharing"
_TEST_URL = "https://drive.google.com/file/d/1PqSRvTsqU3nCNZv7pN2gA6NkqOGz0TVE/view?usp=sharing"
...
class FZxMedQADataset(datasets.GeneratorBasedBuilder):
    ...
    force = False
    urls = {datasets.Split.TRAIN: _TRAIN_URL,
    ...
    def _split_generators(self, dl_manager):
        ...
        downloaded_files = {split: dl_manager.download_and_extract(self._get_drive_url(url)) for split, url in
                            self.urls.items()}
